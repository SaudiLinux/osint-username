...
def print_red_bold(text):
    # ANSI escape for bold red
    print(f"\033[1;31m{text}\033[0m")

def main():
    print("="*60)
    print("         OSINT Username Tool")
    print()
    print_red_bold("           SaudiLinux")
    print("    الإيميل: Saudicrackers@gmail.com")
    print("="*60)
    print("أداة OSINT Username - البحث عن اسم مستخدم في المواقع والبريد الإلكتروني\n")
